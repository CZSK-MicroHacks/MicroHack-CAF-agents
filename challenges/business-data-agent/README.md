...
Z architektonického pohledu budeš vytvářet [Lakehouse](/challenges/business-data-agent/challenges/lakehouse-layers.md) v platformě [Microsoft Fabric](https://www.microsoft.com/en-us/microsoft-fabric/resources/data-101/what-is-fabric?msockid=37ed1b5fdff06f8b2508082bde936ec1).
...
5. ***volitelný*** [Automatické testovaní datového agenta přes SDK](/challenges/business-data-agent/challenges/05_data_agent_sdk.md)
